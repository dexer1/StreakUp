...
export const useAppStore = create<AppState>()(persist((set) => ({
  ...
  pushDemoEvent: () => set((state) => { const notification = { id: `live-${Date.now()}`, type: "social" as const, message: "Sarah sent a Fire reaction to your 12-day streak.", createdAt: new Date().toISOString(), read: false }; return { notifications: [notification, ...state.notifications], toast: { id: Date.now(), message: "New activity from Sarah.", tone: "info" } }; }),
